...
def partial_satisfiable(partial_fn: functools.partial) -> bool:
    # TODO: document https://gitlab.lrz.de/cps/commonroad-geometric/-/issues/3
...
def get_function_return_variable_name(fn) -> str:
    # TODO: document & make less hacky https://gitlab.lrz.de/cps/commonroad-geometric/-/issues/3

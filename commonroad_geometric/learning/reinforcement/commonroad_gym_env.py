...
from commonroad_geometric.learning.reinforcement.rewarder.reward_aggregator.base_reward_aggregator import \
...
from commonroad_geometric.learning.reinforcement.termination_criteria.base_termination_criterion import \
    BaseTerminationCriterion
from commonroad_geometric.rendering.traffic_scene_renderer import DEFAULT_FPS, T_Frame, TrafficSceneRenderer, \
...
class CommonRoadGymEnv(gymnasium.Env, Generic[T_SimulationOptions]):
    ...
    def step(
        ...
        # Change: 在info中添加了ego_vehicle_simulation的信息，以便reactive_planner进行规划
        info['ego_vehicle_simulation'] = self._ego_vehicle_simulation
    ...
    def reset(
        ...
        # Change: 在info中添加了ego_vehicle_simulation的信息，以便reactive_planner进行规划
        info['ego_vehicle_simulation'] = self.ego_vehicle_simulation

...
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.detail_central_vertices import detail_cv
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.intersection_planner import distance_lanelet
import numpy as np
import matplotlib.pyplot as plt
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import get_detail_cv_of_lanelets, lanelet_network2grid, state_cr2state_mcts
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import get_obstacle_info
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import get_map_info
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import edit_scenario4test
# from MCTs_v3proSP3T import NaughtsAndCrossesState, mcts, output, checker
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.MCTs_v3pro_2 import NaughtsAndCrossesState, mcts, output, checker


from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import get_frenet_lanelet_axis, find_adj_lanelets
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.grid_lanelet import generate_len_map, find_target_frenet_axis, extract_speed_limit_from_traffic_sign
...
class MCTs_CR():
    ...
    def cut_lanelet_route(self, ego_state):
        ...
        try:
            ...
            lanelet_id_ego = lanelet_id_ego_list[0]

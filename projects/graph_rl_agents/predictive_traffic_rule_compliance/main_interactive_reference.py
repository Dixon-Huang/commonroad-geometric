...
from sumo_simulation.utility import save_solution
from sumo_simulation.simulations import load_sumo_configuration
from lattice.route_planner import route_planner
from projects.graph_rl_agents.predictive_traffic_rule_compliance.lattice.Lattice_CRv3 import Lattice_CRv3
from lattice.intersection_planner import front_vehicle_info_extraction, IntersectionPlanner
from lattice.MCTs_CR import MCTs_CR
from projects.graph_rl_agents.predictive_traffic_rule_compliance.k_level.utility  import distance_lanelet, brake
...
class InteractiveCRPlanner:
    ...
    def generate_route(self, scenario, planning_problem):
        ...
        if route:
            self.lanelet_route = route.lanelet_ids
